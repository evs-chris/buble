module.exports = [
...

	{
		...
		output: `
			var Foo = (function (Bar) {
				...
				Foo__proto__.baz = function ( a, b, c ) {
...

	{
		...
		output: `
			...
			Foo__proto__.before = function () {
				// code goes here
			};

			Foo__proto__.after = function () {
				// code goes here
			};`
	},
